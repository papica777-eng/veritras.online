...
export class VortexOrchestrator {
    ...
    private async triggerEmergencyOptimization(): Promise<void> {
        ...
        // Terminate bottom 20% of assets
        const terminationCount = Math.ceil(sortedByHealth.length * 0.2);
    ...
    public getStatus(): {
        ...
        return {
            ...
            uptime: this.lastMutationCycle > 0 ? Date.now() - this.lastMutationCycle : 0,
            lastMutation: this.lastMutationCycle,
            subsystems: {
