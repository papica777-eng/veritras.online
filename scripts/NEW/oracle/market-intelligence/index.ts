...
export {
  ...
  type StealthLevel
} from '../../../qantum/Oracle/EnterpriseDiscovery';
...
export {
  ...
  type ComplexityTier,
  type CrawlDataInput
} from '../../../qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint';
...
export {
  ...
  type CostEstimate,
  type TimeWindow
} from '../../../qantum/SaaS-Framework/scripts/chronos/PredictiveScaler';
...
import { EnterpriseDiscovery, createEnterpriseDiscovery } from '../../../qantum/Oracle/EnterpriseDiscovery';
import { MarketBlueprint, createMarketBlueprint } from '../../../qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint';
import { PredictiveScaler, createPredictiveScaler } from '../../../qantum/SaaS-Framework/scripts/chronos/PredictiveScaler';
...
export function createMarketIntelligencePipeline(config?: {
  discovery?: Partial<import('../../../qantum/Oracle/EnterpriseDiscovery').EnterpriseDiscoveryConfig>;
  blueprint?: Partial<import('../../../qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint').MarketBlueprintConfig>;
  scaler?: Partial<import('../../../qantum/SaaS-Framework/scripts/chronos/PredictiveScaler').PredictiveScalerConfig>;
