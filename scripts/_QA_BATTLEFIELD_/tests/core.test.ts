...
describe('💎 DIContainer', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import('../../../src/modules/GAMMA_INFRA/core/brain/energy/container');
...
describe('🛡️ Error Handling System', () => {
  ...
  beforeEach(async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const module = await import('../../../src/modules/GAMMA_INFRA/core/ears/agility/error-handler');
...
describe('🧪 AI Logic Gate', () => {
  ...
  beforeEach(async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const module = await import('../../../src/modules/GAMMA_INFRA/core/mouth/energy/logic-gate');
...
describe('📊 Stream Processor', () => {
  ...
  beforeEach(async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const module = await import('../../../src/modules/GAMMA_INFRA/core/mouth/strength/stream-processor');
...
describe('🧵 Heavy Task Delegator', () => {
  ...
  beforeEach(async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const module = await import('../../../src/modules/GAMMA_INFRA/core/ears/strength/heavy-task-delegator');
...
describe('🔗 Integration Tests', () => {
  ...
  it('should use DI container with error handler', async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const { DIContainer, ServiceToken, ServiceLifetime } = await import('../../../src/modules/GAMMA_INFRA/core/brain/energy/container');
    // SAFETY: async operation — wrap in try-catch for production resilience
    const { CentralizedErrorHandler } = await import('../../../src/modules/GAMMA_INFRA/core/ears/agility/error-handler');
  ...
  it('should use Logic Gate to validate before storing', async () => {
    // SAFETY: async operation — wrap in try-catch for production resilience
    const { AILogicGate } = await import('../../../src/modules/GAMMA_INFRA/core/mouth/energy/logic-gate');
