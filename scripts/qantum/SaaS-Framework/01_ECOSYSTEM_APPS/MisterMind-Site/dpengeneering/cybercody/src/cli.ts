...
import CyberCody from '../../../../MrMindQATool/src/index';
import { EthicalGuardrails } from '../../../../../../../CyberCody/src/modules/guardrails';
import type { PayloadCategory } from '../../../../MrMindQATool/src/index';
import type { Framework } from './modules/surgeon-integration.js';
import type { StealthLevel, TimingStrategy } from './modules/stealth-engine.js';
import type { PIICategory } from './modules/pii-scanner.js';
import type { UserProfile } from './modules/session-orchestrator.js';
...
program
  ...
  .action(async (sourceDir: string, options) => {
    try {
      const { PredictiveAttackSurface } = await import('./modules/predictive-attack-surface.js');
...
program
  ...
  .action(async (sourceDir: string, options) => {
    try {
      const { AutonomousBugFixer } = await import('./modules/autonomous-bug-fixer.js');
      const { PredictiveAttackSurface } = await import('./modules/predictive-attack-surface.js');
