...
export type PayloadCategory = 'xss' | 'sqli' | 'nosqli' | 'cmdi' | 'pathtraversal' | 'ssti' | 'xxe' | 'ssrf' | 'idor' | 'overflow' | 'format' | 'unicode' | 'null' | 'boundary';
/**
...
export type AnomalyType = 'status_change' | 'error_disclosure' | 'timing_anomaly' | 'size_anomaly' | 'reflection' | 'header_anomaly' | 'behavior_change';
/**
 ...
 */
export type WorkerMessageType = 'INIT' | 'TASK' | 'RESULT' | 'ERROR' | 'PROGRESS' | 'COMPLETE' | 'TERMINATE';
