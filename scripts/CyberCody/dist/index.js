...
import { APIInterceptor } from './modules/api-interceptor.js';
import { BOLATester } from './modules/bola-tester.js';
import { LogicAnalyzer } from './modules/logic-analyzer.js';
import { SurgeonIntegration } from './modules/surgeon-integration.js';
import { ShadowAPIDiscovery } from './modules/shadow-api-discovery.js';
// v1.2 Ghost Auditor Modules
import { SessionOrchestrator, } from './modules/session-orchestrator.js';
import { PIIScanner, } from './modules/pii-scanner.js';
import { StealthEngine, } from './modules/stealth-engine.js';
import { RemediationGenerator, } from './modules/remediation-gen.js';
// v1.3 Visual Hacker Modules
import { VisualPhishingDetector, } from './modules/visual-phishing-detector.js';
import { HiddenElementFinder, } from './modules/hidden-element-finder.js';
import { DashboardSync, } from './modules/dashboard-sync.js';
// v25.0 Temporal Healer Modules
import { HotSwapSelectorEngine, } from './modules/hot-swap-selector.js';
import { PredictiveAttackSurface, } from './modules/predictive-attack-surface.js';
import { AutonomousBugFixer, } from './modules/autonomous-bug-fixer.js';
// ═══════════════════════════════════════════════════════════════════════════════
