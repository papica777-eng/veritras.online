...
import type { BOLATestResult, BOLATestReport } from './bola-tester.js';
import type { CrossSessionVulnerability, SessionOrchestratorReport } from './session-orchestrator.js';
