...
export class BatchProcessor<T> extends Transform {
  ...
  override _transform(item: T, encoding: string, callback: (error?: Error | null) => void): void {
...
export class MemoryThrottleTransform extends Transform {
  ...
  override _transform(chunk: unknown, encoding: string, callback: Function): void {
