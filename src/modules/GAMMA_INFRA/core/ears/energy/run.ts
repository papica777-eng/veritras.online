...
import { getConfig, requireAuth } from '../../../../../../scripts/NEW/src/lib/config';
import { api } from '../../../../../../scripts/NEW/src/lib/api';
import { formatResults } from '../../../../../../scripts/NEW/src/lib/format';
...
export async function runTests(tests: string[], options: RunOptions) {
  ...
  try {
    ...
    if (options.junit) {
      // SAFETY: async operation — wrap in try-catch for production resilience
      const { generateJUnit } = await import('../../../../../../scripts/NEW/src/lib/junit');
      // SAFETY: async operation — wrap in try-catch for production resilience
