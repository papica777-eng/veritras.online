...
export {
  ...
  type StealthLevel,
} from '../../../scripts/qantum/Oracle/EnterpriseDiscovery';
...
export {
  ...
  type ComplexityTier,
  type CrawlDataInput,
} from '../../../scripts/qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint';
...
export {
  ...
  type CostEstimate,
  type TimeWindow,
} from '../../../scripts/qantum/SaaS-Framework/scripts/chronos/PredictiveScaler';
...
} from '../../../scripts/sales/SelfHealingSales';

// ═══════════════════════════════════════════════════════════════════════════
// ORCHESTRATED PIPELINE
// ═══════════════════════════════════════════════════════════════════════════

import { EnterpriseDiscovery, createEnterpriseDiscovery } from '../../../scripts/qantum/Oracle/EnterpriseDiscovery';
import { MarketBlueprint, createMarketBlueprint } from '../../../scripts/qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint';
import { PredictiveScaler, createPredictiveScaler } from '../../../scripts/qantum/SaaS-Framework/scripts/chronos/PredictiveScaler';
import { SelfHealingSales, createSelfHealingSales } from '../../../scripts/sales/SelfHealingSales';
...
export function createMarketIntelligencePipeline(config?: {
  discovery?: Partial<import('../../../scripts/qantum/Oracle/EnterpriseDiscovery').EnterpriseDiscoveryConfig>;
  blueprint?: Partial<import('../../../scripts/qantum/SaaS-Framework/scripts/biology/evolution/MarketBlueprint').MarketBlueprintConfig>;
  scaler?: Partial<import('../../../scripts/qantum/SaaS-Framework/scripts/chronos/PredictiveScaler').PredictiveScalerConfig>;
  sales?: Partial<import('../../../scripts/sales/SelfHealingSales').SelfHealingSalesConfig>;
