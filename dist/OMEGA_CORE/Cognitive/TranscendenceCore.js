...
exports.transcendence = exports.TranscendenceEngine = exports.Pataphysics = exports.Deconstruction = exports.HegelianDialectics = exports.Hypergame = exports.Nomic = exports.StrangeLoop = exports.Dialetheism = exports.ParaconsistentLogic = exports.ZenKoan = exports.JainaSyadavada = exports.Catuskoti = exports.GodelNumbering = exports.ARISTOTELIAN_LAWS = void 0;
exports.ARISTOTELIAN_LAWS = [
    {
...
exports.GodelNumbering = GodelNumbering;
//
...
class Catuskoti {
    ...
    hasAffirmativeIndicators(p) {
        return /\b(is|exists|has|true|yes|asti)\b/i.test(p);
    }
    hasNegativeIndicators(p) {
...
exports.Catuskoti = Catuskoti;
class JainaSyadavada {
    /**
     * Apply the seven-fold predication to a proposition
     */
    analyzeSevenFold(proposition, context) {
        return {
            predications: [
                {
                    value: 'SYAT_ASTI',
...
exports.JainaSyadavada = JainaSyadavada;
class ZenKoan {
    koans = [
        {
        ...
        },
        {
            ...
            bypass: 'Лицето преди раждането е лицето после просветлението - не-аз.'
        },
        {
...
class ParaconsistentLogic {
     ...
     */
    evaluateWithContradiction(P, notP, Q) {
...
exports.ParaconsistentLogic = ParaconsistentLogic;
class Dialetheism {
    /**
     * Evaluate statements that may be true contradictions (dialetheia)
     */
    evaluateDialetheia(statement) {
...
exports.Dialetheism = Dialetheism;
//
...
exports.HegelianDialectics = HegelianDialectics;
class Deconstruction {
    /**
     * Find the aporia - the loose thread that unravels the text
     */
    deconstruct(binaryOpposition) {
        return {
...
exports.Deconstruction = Deconstruction;
class Pataphysics {
    /**
     * The Science of Imaginary Solutions
     */
    generateImaginarySolution(problem) {
        return {
            problem,
        ...
        2. EQUIVALENCE: Всички неща еквивалентни в своята особеност
...
exports.Pataphysics = Pataphysics;
//
// PART IX: THE TRANSCENDENCE ENGINE - SYNTHESIS
//
class TranscendenceEngine {
    godel = new GodelNumbering();
    catuskoti = new Catuskoti();
    jaina = new JainaSyadavada();
    zen = new ZenKoan();
    paraconsistent = new ParaconsistentLogic();
    dialetheism = new Dialetheism();
    strangeLoop = new StrangeLoop();
    hegel = new HegelianDialectics();
    derrida = new Deconstruction();
    pataphysics = new Pataphysics();
    /**
    ...
    generateGoldenKey(problem, analysis) {
        return `
...
exports.TranscendenceEngine = TranscendenceEngine;
//
// EXPORTS
//
exports.transcendence = new TranscendenceEngine();
exports.default = TranscendenceEngine;
