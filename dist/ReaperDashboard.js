...
exports.reaperDashboard = exports.ReaperDashboard = void 0;
const events_1 = require("events");
// ═══════════════════════════════════════════════════════════════════════════
// REAPER DASHBOARD
// ═══════════════════════════════════════════════════════════════════════════
class ReaperDashboard extends events_1.EventEmitter {
    metrics;
    tradeLogs = [];
    alertConfig;
    telemetryUrl;
    isConnected = false;
    updateInterval = null;
    constructor(telemetryUrl = 'ws://192.168.0.6:8888') {
        super();
...
exports.ReaperDashboard = ReaperDashboard;
// ═══════════════════════════════════════════════════════════════════════════
// SINGLETON EXPORT
// ═══════════════════════════════════════════════════════════════════════════
exports.reaperDashboard = new ReaperDashboard('ws://192.168.0.6:8888');
exports.default = ReaperDashboard;
