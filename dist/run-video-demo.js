...
const SelfHealingEngine_1 = require("./src/engines/SelfHealingEngine");
/**
 * =========================================================================
...
async function runDemo() {
    ...
    async function nexusLog(msg, colorHex = '#a78bfa') {
        console.log(msg); // Node.js terminal
        await page.evaluate(({ m, c }) => {
            window.logToVortex(m, c);
        }, { m: msg, c: colorHex });
    }
    ...
    const healer = new SelfHealingEngine_1.SelfHealingEngine({
        enabled: true,
        maxAttempts: 15,
        timeout: 2000,
