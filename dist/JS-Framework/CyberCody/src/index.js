...
exports.EthicalGuardrails = exports.VulnerabilitySnapshotModule = exports.FuzzingEngine = exports.ReconModule = exports.AutonomousBugFixer = exports.PredictiveAttackSurface = exports.HotSwapSelectorEngine = exports.DashboardSync = exports.HiddenElementFinder = exports.VisualPhishingDetector = exports.RemediationGenerator = exports.StealthEngine = exports.PIIScanner = exports.SessionOrchestrator = exports.ShadowAPIDiscovery = exports.SurgeonIntegration = exports.LogicAnalyzer = exports.BOLATester = exports.APIInterceptor = exports.CyberCody = void 0;
const events_1 = require("events");
// v1.0 Core Modules
const recon_js_1 = require("./modules/recon.js");
const fuzzing_js_1 = require("./modules/fuzzing.js");
const snapshot_js_1 = require("./modules/snapshot.js");
const guardrails_js_1 = require("./modules/guardrails.js");
// v1.1 API Logic Hunter Modules
const api_interceptor_js_1 = require("./modules/api-interceptor.js");
Object.defineProperty(exports, "APIInterceptor", { enumerable: true, get: function () { return api_interceptor_js_1.APIInterceptor; } });
const bola_tester_js_1 = require("./modules/bola-tester.js");
Object.defineProperty(exports, "BOLATester", { enumerable: true, get: function () { return bola_tester_js_1.BOLATester; } });
const logic_analyzer_js_1 = require("./modules/logic-analyzer.js");
Object.defineProperty(exports, "LogicAnalyzer", { enumerable: true, get: function () { return logic_analyzer_js_1.LogicAnalyzer; } });
const surgeon_integration_js_1 = require("./modules/surgeon-integration.js");
Object.defineProperty(exports, "SurgeonIntegration", { enumerable: true, get: function () { return surgeon_integration_js_1.SurgeonIntegration; } });
const shadow_api_discovery_js_1 = require("./modules/shadow-api-discovery.js");
Object.defineProperty(exports, "ShadowAPIDiscovery", { enumerable: true, get: function () { return shadow_api_discovery_js_1.ShadowAPIDiscovery; } });
// v1.2 Ghost Auditor Modules
const session_orchestrator_js_1 = require("./modules/session-orchestrator.js");
...
const pii_scanner_js_1 = require("./modules/pii-scanner.js");
Object.defineProperty(exports, "PIIScanner", { enumerable: true, get: function () { return pii_scanner_js_1.PIIScanner; } });
const stealth_engine_js_1 = require("./modules/stealth-engine.js");
Object.defineProperty(exports, "StealthEngine", { enumerable: true, get: function () { return stealth_engine_js_1.StealthEngine; } });
const remediation_gen_js_1 = require("./modules/remediation-gen.js");
Object.defineProperty(exports, "RemediationGenerator", { enumerable: true, get: function () { return remediation_gen_js_1.RemediationGenerator; } });
// v1.3 Visual Hacker Modules
const visual_phishing_detector_js_1 = require("./modules/visual-phishing-detector.js");
Object.defineProperty(exports, "VisualPhishingDetector", { enumerable: true, get: function () { return visual_phishing_detector_js_1.VisualPhishingDetector; } });
const hidden_element_finder_js_1 = require("./modules/hidden-element-finder.js");
Object.defineProperty(exports, "HiddenElementFinder", { enumerable: true, get: function () { return hidden_element_finder_js_1.HiddenElementFinder; } });
const dashboard_sync_js_1 = require("./modules/dashboard-sync.js");
Object.defineProperty(exports, "DashboardSync", { enumerable: true, get: function () { return dashboard_sync_js_1.DashboardSync; } });
// v25.0 Temporal Healer Modules
const hot_swap_selector_js_1 = require("./modules/hot-swap-selector.js");
const predictive_attack_surface_js_1 = require("./modules/predictive-attack-surface.js");
const autonomous_bug_fixer_js_1 = require("./modules/autonomous-bug-fixer.js");
// ═══════════════════════════════════════════════════════════════════════════════
 ...
 * ```
 */
class CyberCody extends events_1.EventEmitter {
    config;
    recon;
    fuzzer;
    snapshots;
    ...
    constructor(config = {}) {
        ...
        // Initialize modules
        this.recon = new recon_js_1.ReconModule(this.config.recon);
        this.fuzzer = new fuzzing_js_1.FuzzingEngine(this.config.fuzzing);
        this.snapshots = new snapshot_js_1.VulnerabilitySnapshotModule();
        this.guardrails = new guardrails_js_1.EthicalGuardrails(this.config.ethical);
        this.printBanner();
    }
    /**
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    generateSummary(scan) {
        ...
        const riskScore = Math.min(100, bySeverity.critical * 25 +
            bySeverity.high * 15 +
            bySeverity.medium * 5 +
            bySeverity.low * 1);
...
<body>
  ...
  <footer style="text-align: center; margin-top: 40px; color: #666;">
     ...
     */
    async apiSecurityAudit(target, options = {}) {
        const startTime = new Date();
        ...
        const interceptor = new api_interceptor_js_1.APIInterceptor({ target });
        ...
        const bolaTester = new bola_tester_js_1.BOLATester({
            apiMap,
        ...
        if (options.analyzeDataExposure !== false) {
            ...
            const logicAnalyzer = new logic_analyzer_js_1.LogicAnalyzer({
        ...
        if (options.discoverShadowAPIs) {
            ...
            const shadowDiscovery = new shadow_api_discovery_js_1.ShadowAPIDiscovery({ target });
        ...
        if (options.generatePatches && options.framework) {
            ...
            const surgeon = new surgeon_integration_js_1.SurgeonIntegration({ framework: options.framework });
     ...
     */
    calculateOverallRisk(bolaReport, logicReport, shadowReport) {
        let score = 0;
        let factors = 0;
        if (bolaReport) {
     ...
     */
    generateAPIRecommendations(bolaReport, logicReport, shadowReport) {
        const recommendations = [];
...
`);
     ...
     */
    async ghostAudit(target, options = {}) {
        const startTime = new Date();
        ...
        // Initialize modules
        const sessionOrchestrator = new session_orchestrator_js_1.SessionOrchestrator({
            maxProfiles: 10,
            parallelTests: 4,
        });
        const piiScanner = new pii_scanner_js_1.PIIScanner({
        ...
        const stealthEngine = new stealth_engine_js_1.StealthEngine({
        ...
        const remediationGen = new remediation_gen_js_1.RemediationGenerator({
        ...
        if (options.userProfiles && options.userProfiles.length > 0) {
            for (const profile of options.userProfiles) {
                sessionOrchestrator.addProfile(profile.name, profile.credentials?.token ?? '', profile.role, profile.authType);
            }
        ...
        for (const request of apiMap.requests) {
            if (request.response?.body) {
                const result = await piiScanner.scanAPIResponse(request.url, request.method, request.response.body, request.response.headers ?? {});
        ...
        const report = {
            ...
            piiReport: {
                ...
                categoriesFound: Object.keys(piiReport.detectionsByCategory),
     ...
     */
    async quickPIIScan(target, options = {}) {
        ...
        for (const request of apiMap.requests) {
            if (request.response?.body) {
                await piiScanner.scanAPIResponse(request.url, request.method, request.response.body, request.response.headers ?? {});
            }
        }
    ...
    registerUserProfile(profile) {
        const orchestrator = new session_orchestrator_js_1.SessionOrchestrator();
        orchestrator.addProfile(profile.name, profile.credentials?.token ?? '', profile.role, profile.authType);
        console.log(`✅ Registered profile: ${profile.name} (${profile.role})`);
    }
    /**
     * Calculate risk score for ghost audit
     */
    calculateGhostRiskScore(sessionResult, piiReport, bolaReport) {
        let score = 0;
     ...
     */
    countCriticalIssues(sessionResult, piiReport, bolaReport) {
        return (sessionResult.vulnerabilitiesFound.filter(v => v.severity === 'critical').length +
     ...
     */
    generateGhostRecommendations(sessionResult, piiReport, bolaReport) {
        const recommendations = [];
...
`);
     ...
     */
    async visualHack(target, options = {}) {
        const startTime = new Date();
        console.log(`
╔══════════════════════════════════════════════════════════════════════════════╗
...
`);
        ...
        if (options.syncToDashboard) {
            ...
            dashboardSync = new dashboard_sync_js_1.DashboardSync({
        ...
        const phishingDetector = new visual_phishing_detector_js_1.VisualPhishingDetector({
            geminiApiKey: options.geminiApiKey,
        ...
        const hiddenFinder = new hidden_element_finder_js_1.HiddenElementFinder({
        ...
        if (dashboardSync) {
            const dashboardReport = dashboardSync.buildSecurityReport(target, 'visual', startTime, endTime, {
                phishingReport: {
                    phishingDetected: phishingReport.phishingDetected,
     ...
     */
    async quickPhishingScan(urls, options = {}) {
        console.log('\n🎣 [QUICK PHISHING SCAN] Analyzing URLs for phishing indicators...\n');
        const detector = new visual_phishing_detector_js_1.VisualPhishingDetector({
            geminiApiKey: options.geminiApiKey,
            sensitivityLevel: options.sensitivityLevel ?? 'medium',
        });
        try {
     ...
     */
    async quickHiddenScan(target, options = {}) {
        console.log('\n🔍 [QUICK HIDDEN SCAN] Discovering hidden elements...\n');
        const finder = new hidden_element_finder_js_1.HiddenElementFinder({
            captureScreenshots: options.captureScreenshots ?? true,
            revealHiddenElements: options.revealHiddenElements ?? false,
        });
        try {
     ...
     */
    calculateVisualRiskScore(phishingReport, hiddenReport) {
        const phishingWeight = 0.6;
        const hiddenWeight = 0.4;
        return Math.round((phishingReport.overallRiskScore * phishingWeight) +
            (hiddenReport.riskScore * hiddenWeight));
    }
    /**
     * Generate visual security recommendations
     */
    generateVisualRecommendations(phishingReport, hiddenReport) {
        const recommendations = [];
...
`);
     ...
     */
    async temporalHeal(sourceDir, options = {}) {
        const startTime = new Date();
        console.log(`
╔══════════════════════════════════════════════════════════════════════════════╗
...
`);
        // Initialize modules
        const predictiveEngine = new predictive_attack_surface_js_1.PredictiveAttackSurface({
            sourceDir,
            geminiApiKey: options.geminiApiKey,
        ...
        const bugFixer = new autonomous_bug_fixer_js_1.AutonomousBugFixer({
            repoRoot: sourceDir,
        ...
        const hotSwapEngine = new hot_swap_selector_js_1.HotSwapSelectorEngine({
            geminiApiKey: options.geminiApiKey,
        ...
        if (dashboardSync) {
            const dashboardReport = {
                ...
                vulnerabilities: attackSurfaceAnalysis.currentVulnerabilities.map(v => ({
                    id: v.id,
                    type: v.category,
                    severity: v.currentRiskScore >= 80 ? 'critical' : v.currentRiskScore >= 60 ? 'high' : 'medium',
                    target: sourceDir,
                    endpoint: v.filePath,
     ...
     */
    printTemporalHealSummary(report) {
...
exports.CyberCody = CyberCody;
// Export v25.0 modules
var hot_swap_selector_js_2 = require("./modules/hot-swap-selector.js");
Object.defineProperty(exports, "HotSwapSelectorEngine", { enumerable: true, get: function () { return hot_swap_selector_js_2.HotSwapSelectorEngine; } });
var predictive_attack_surface_js_2 = require("./modules/predictive-attack-surface.js");
Object.defineProperty(exports, "PredictiveAttackSurface", { enumerable: true, get: function () { return predictive_attack_surface_js_2.PredictiveAttackSurface; } });
var autonomous_bug_fixer_js_2 = require("./modules/autonomous-bug-fixer.js");
Object.defineProperty(exports, "AutonomousBugFixer", { enumerable: true, get: function () { return autonomous_bug_fixer_js_2.AutonomousBugFixer; } });
// Export main class and modules
var recon_js_2 = require("./modules/recon.js");
Object.defineProperty(exports, "ReconModule", { enumerable: true, get: function () { return recon_js_2.ReconModule; } });
var fuzzing_js_2 = require("./modules/fuzzing.js");
Object.defineProperty(exports, "FuzzingEngine", { enumerable: true, get: function () { return fuzzing_js_2.FuzzingEngine; } });
var snapshot_js_2 = require("./modules/snapshot.js");
Object.defineProperty(exports, "VulnerabilitySnapshotModule", { enumerable: true, get: function () { return snapshot_js_2.VulnerabilitySnapshotModule; } });
var guardrails_js_2 = require("./modules/guardrails.js");
Object.defineProperty(exports, "EthicalGuardrails", { enumerable: true, get: function () { return guardrails_js_2.EthicalGuardrails; } });
__exportStar(require("./types/index.js"), exports);
exports.default = CyberCody;
