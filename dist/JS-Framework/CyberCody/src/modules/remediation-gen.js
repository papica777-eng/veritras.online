...
exports.RemediationGenerator = void 0;
 ...
 */
class RemediationGenerator extends events_1.EventEmitter {
    config;
    patches = [];
    constructor(config = {}) {
        super();
     ...
     */
    generateBOLAMiddleware(endpoint, param) {
    ...
    generateExpressBOLAMiddleware(endpoint, param) {
        return `// ═══════════════════════════════════════════════════════════════════════════
...
`;
    ...
    generateFastifyBOLAMiddleware(endpoint, param) {
        return `// ═══════════════════════════════════════════════════════════════════════════
...
`;
    ...
    generateNestBOLAMiddleware(endpoint, param) {
        return `// ═══════════════════════════════════════════════════════════════════════════
...
`;
    ...
    generateFastAPIBOLAMiddleware(endpoint, param) {
        return `# ═══════════════════════════════════════════════════════════════════════════
...
`;
    ...
    generateDjangoBOLAMiddleware(endpoint, param) {
        return `# ═══════════════════════════════════════════════════════════════════════════
...
`;
    ...
    generatePIISanitizerCode(report) {
        return `// ═══════════════════════════════════════════════════════════════════════════
...
// TODO: Implement field-specific filtering based on your data model`,
     ...
     */
    generateFromSessionReport(report) {
...
`;
    ...
    generateReport(target) {
        ...
        const sortedPatches = [...this.patches].sort((a, b) => priorityOrder[a.priority] - priorityOrder[b.priority]);
        return {
            target,
     ...
     */
    estimateEffort(summary) {
        const hours = summary.bolaPatches * 2 +
...
exports.RemediationGenerator = RemediationGenerator;
exports.default = RemediationGenerator;
