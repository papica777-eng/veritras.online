...
exports.MultiLanguageCognition = exports.JAPANESE_PATTERNS = exports.CHINESE_PATTERNS = exports.ENGLISH_PATTERNS = exports.BULGARIAN_PATTERNS = void 0;
// ═══════════════════════════════════════════════════════════════════════════════
// 🇧🇬 BULGARIAN LANGUAGE COGNITION
// ═══════════════════════════════════════════════════════════════════════════════
exports.BULGARIAN_PATTERNS = {
    language: 'bg',
...
// ═══════════════════════════════════════════════════════════════════════════════
class MultiLanguageCognition {
    supportedLanguages = new Map();
    activeLanguage = 'auto';
    detectedLanguage = null;
    constructor() {
        // Register built-in languages (v26.0: Now supports 6 core languages)
        this.registerLanguage(exports.BULGARIAN_PATTERNS);
        this.registerLanguage(exports.ENGLISH_PATTERNS);
        this.registerLanguage(exports.CHINESE_PATTERNS);
        this.registerLanguage(exports.JAPANESE_PATTERNS);
    }
    /**
     ...
     */
    calculateConfidence(transcript, match) {
     ...
     */
    extractEntities(transcript, language) {
        const entities = [];
        const patterns = this.supportedLanguages.get(language);
        // Extract URLs
     ...
     */
    buildAction(type, transcript, entities, language) {
     ...
     */
    extractTargetFromTranscript(transcript, language) {
     ...
     */
    buildSelector(transcript, elementType, language) {
     ...
     */
    translateEntity(value, language) {
        const patterns = this.supportedLanguages.get(language);
        if (!patterns)
            return value;
        for (const mapping of patterns.entityMappings) {
...
exports.MultiLanguageCognition = MultiLanguageCognition;
// ═══════════════════════════════════════════════════════════════════════════════
// 📦 EXPORTS
// ═══════════════════════════════════════════════════════════════════════════════
exports.default = MultiLanguageCognition;
