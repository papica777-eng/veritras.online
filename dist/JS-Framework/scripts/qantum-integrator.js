...
exports.QAntumIntegrator = void 0;
...
class QAntumIntegrator {
     ...
     */
    identifyOmniCoreModules(topModules) {
     ...
     */
    identifySharedLibraryModules(topModules) {
     ...
     */
    generateTrainingDataset(topModules) {
        ...
        topModules.forEach(moduleValue => {
            ...
            if (!doc || !fs.existsSync(moduleValue.file))
                return;
     ...
     */
    createSharedLibraryStructure(modules, outputDir) {
...
`;
     ...
     */
    generateOmniCoreGuide(modules, outputDir) {
     ...
     */
    saveIntegrationPlan(plan, outputDir) {
        // Save full plan
...
exports.QAntumIntegrator = QAntumIntegrator;
// Main execution
