...
exports.SurgeonIntegration = void 0;
// ╔══════════════════════════════════════════════════════════════════════════════╗
 ...
 */
function generateBOLAMiddleware(result, framework, _language) {
 ...
 */
function generateDataExposureFilter(exposure, framework, _language) {
 ...
 */
function generateRateLimiter(framework) {
    switch (framework) {
        case 'express':
            return `
// ═══════════════════════════════════════════════════════════════════════════
 ...
 */
class SurgeonIntegration extends events_1.EventEmitter {
    config;
    patches = [];
    constructor(config) {
        super();
    ...
    generateBOLAPatches(results) {
        const confirmedVulns = results.filter(r => r.vulnerability.detected && r.vulnerability.confidence !== 'low');
    ...
    generateDataExposurePatches(results) {
     ...
     */
    // Complexity: O(N)
    getIntegrationSteps(type, endpoint) {
        const steps = [];
        switch (type) {
            case 'bola':
...
exports.SurgeonIntegration = SurgeonIntegration;
exports.default = SurgeonIntegration;
