 ...
 * core — Qantum Module
 * @module core
 * @path scripts/qantum/SaaS-Framework/scripts/OTHERS/core.ts
...
const validation_error_1 = __importDefault(require("./runtime/validation_error"));
const ref_error_1 = __importDefault(require("./compile/ref_error"));
const rules_2 = require("./compile/rules");
const compile_2 = require("./compile");
const codegen_2 = require("./compile/codegen");
const resolve_1 = require("./compile/resolve");
const dataType_1 = require("./compile/validate/dataType");
const util_1 = require("./compile/util");
const $dataRefSchema = __importStar(require("./refs/data.json"));
const uri_1 = __importDefault(require("./runtime/uri"));
...
function requiredOptions(o) {
    ...
    const uriResolver = o.uriResolver ?? uri_1.default;
    return {
...
class Ajv {
    ...
    _cache = new Map();
    _metaOpts;
    static ValidationError = validation_error_1.default;
    static MissingRefError = ref_error_1.default;
    constructor(opts = {}) {
    ...
    getSchema(keyRef) {
        ...
        if (sch === undefined) {
            const { schemaId } = this.opts;
            const root = new compile_2.SchemaEnv({ schema: {}, schemaId });
    ...
    _addSchema(schema, meta, baseId, validateSchema = this.opts.validateSchema, addSchema = this.opts.addUsedSchema) {
        ...
        sch = new compile_2.SchemaEnv({ schema, schemaId, meta, baseId, localRefs });
