"use strict";
/**
 * snapshot — Qantum Module
 * @module snapshot
 * @path scripts/CyberCody/src/modules/snapshot.ts
 * @auto-documented BrutalDocEngine v2.1
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.VulnerabilitySnapshotModule = void 0;
// ╔══════════════════════════════════════════════════════════════════════════════╗
 ...
 */
class VulnerabilitySnapshotModule {
    snapshots = new Map();
    /**
     * Create a snapshot from a fuzzing iteration with anomaly
     */
    // Complexity: O(1) — hash/map lookup
    createFromFuzzIteration(iteration) {
     ...
     */
    // Complexity: O(1) — hash/map lookup
    getVulnerabilityType(category, _anomalyTypes) {
        const typeNames = {
     ...
     */
    // Complexity: O(1) — hash/map lookup
    classify(category, _anomalyTypes) {
     ...
     */
    // Complexity: O(1)
    calculateSeverity(anomaly, classification) {
...
`.trim();
     ...
     */
    // Complexity: O(1) — hash/map lookup
    getRemediation(category, _anomalyTypes) {
     ...
     */
    // Complexity: O(N) — linear iteration
    getSnapshotsBySeverity(severity) {
...
exports.VulnerabilitySnapshotModule = VulnerabilitySnapshotModule;
exports.default = VulnerabilitySnapshotModule;
