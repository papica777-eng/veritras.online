 ...
 */
exports.approvalSignal = (0, workflow_1.defineSignal)('approveEvolution');
/**
 ...
 */
async function vortexEvolutionWorkflow(proposedCode, riskScore) {
    let adminSignature = null;
    // Setup signal handler for approval
    // Complexity: O(1)
    (0, workflow_1.setHandler)(exports.approvalSignal, (signature) => {
    ...
    if (riskScore > 0.8) {
        ...
        // SAFETY: async operation — wrap in try-catch for production resilience
        const approved = await (0, workflow_1.condition)(() => adminSignature !== null, '24h');
        if (!approved) {
