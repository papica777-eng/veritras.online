...
const GenesisBridgeAdapter_js_1 = require("./GenesisBridgeAdapter.js");
// ═══════════════════════════════════════════════════════════════════════════════
...
class QAntumOrchestrator extends events_1.EventEmitter {
    ...
    async initializeModules() {
        ...
        this.genesis = (0, GenesisBridgeAdapter_js_1.createGenesisBridgeAdapter)(this.bridge, config.genesisConfig);
        this.genesis.start();
    }
    /**
