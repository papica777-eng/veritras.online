...
exports.getNeuralInference = exports.NeuralInference = void 0;
...
class NeuralInference extends events_1.EventEmitter {
    ...
    constructor(ollamaConfig = {}, gpuConfig = {}) {
        super();
     ...
     */
    static getInstance(ollamaConfig, gpuConfig) {
     ...
     */
    async executeInference(request, model) {
     ...
     */
    formatDistilledKnowledge(knowledge) {
        if (!knowledge)
            return '';
        const formatted = [];
...
// EXPORTS
// ═══════════════════════════════════════════════════════════════════════════════
const getNeuralInference = (ollamaConfig, gpuConfig) => NeuralInference.getInstance(ollamaConfig, gpuConfig);
exports.getNeuralInference = getNeuralInference;
