...
class TLSPhantom {
    ...
    rotate() {
        ...
        do {
            ...
            attempts++;
        } while (this.rotationHistory.includes(newProfile.ja3Hash) &&
    ...
    getProfileByBrowser(browserName) {
        const profile = BROWSER_PROFILES.find(p => p.name.toLowerCase().includes(browserName.toLowerCase()));
...
exports.TLSPhantom = TLSPhantom;
exports.default = TLSPhantom;
