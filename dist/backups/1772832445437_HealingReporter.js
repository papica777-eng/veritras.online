...
exports.HealingReporter = void 0;
...
class HealingReporter {
    ...
    saveJSON(filename) {
        ...
        const filepath = path.join(this.config.outputDir, filename ?? `healing-report-${Date.now()}.json`);
...
<body>
  <div class="container">
    ...
    saveHTML(filename) {
        ...
        const filepath = path.join(this.config.outputDir, filename ?? `healing-report-${Date.now()}.html`);
...
exports.HealingReporter = HealingReporter;
exports.default = HealingReporter;
