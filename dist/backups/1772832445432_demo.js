...
const tls_phantom_1 = require("./tls-phantom");
const visual_stealth_1 = require("./visual-stealth");
const biometric_engine_1 = require("./biometric-engine");
const chronos_paradox_1 = require("./chronos-paradox");
// ═══════════════════════════════════════════════════════════════════════════════
// DEMO FUNCTION
// ═══════════════════════════════════════════════════════════════════════════════
async function demo() {
    ...
    const ghost = new index_1.GhostProtocolV2({
    ...
    console.log('─────────────────────────────────────────────');
    const tlsPhantom = new tls_phantom_1.TLSPhantom();
    ...
    console.log('─────────────────────────────────────────────');
    const visualStealth = new visual_stealth_1.VisualStealth();
    ...
    console.log('─────────────────────────────────────────────');
    const biometric = new biometric_engine_1.BiometricEngine();
    // Generate mouse path
    const mousePath = biometric.generateMousePath({ x: 100, y: 100 }, { x: 500, y: 300 });
    ...
    console.log('─────────────────────────────────────────────');
    const chronos = new chronos_paradox_1.ChronosParadox();
    ...
    // SAFETY: async operation — wrap in try-catch for production resilience
    const simulation = await chronos.fastForward('https://example.com', 'Cloudflare Turnstile', 48);
    ...
    const tests = [
        {
            ...
            test: () => {
                const phantom = new tls_phantom_1.TLSPhantom();
        ...
        },
        {
            ...
            test: () => {
                const stealth = new visual_stealth_1.VisualStealth();
        ...
        },
        {
            ...
            test: () => {
                const bio = new biometric_engine_1.BiometricEngine();
        ...
        },
        {
            ...
            test: () => {
                const ghost = new index_1.GhostProtocolV2({ stealthLevel: 'maximum' });
