...
exports.OmegaViewProvider = void 0;
const vscode = __importStar(require("vscode"));
class OmegaViewProvider {
    _extensionUri;
    static viewType = 'qantum-omega-sidebar';
    _view;
    _messages = [];
    _led = { color: 'green', label: 'SYNCED' };
    ...
    async _handleCommand(command, file) {
        const { AIAgentExpert } = await Promise.resolve().then(() => __importStar(require('../intelligence/AIAgentExpert')));
...
exports.OmegaViewProvider = OmegaViewProvider;
function getNonce() {
    let text = '';
