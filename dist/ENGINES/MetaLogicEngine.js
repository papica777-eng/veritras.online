...
exports.metaLogic = exports.MetaLogicEngine = exports.GoldenKey = void 0;
// 
...
class GoldenKey {
     ...
     */
    static transcend(proposition, currentSystem) {
    ...
    static isGoldenKeyMoment(prop, system) {
        // Detect when we've reached a Gödelian limit
        return (prop.selfReference === true ||
...
class MetaLogicEngine {
    ...
    createProposition(id, content, truthValue, catuskotiPosition) {
        const prop = {
            id,
            content,
            truthValue,
    ...
    isParadox(statement) {
        ...
        return ((s.includes('this') && s.includes('false')) ||
            (s.includes('liar') && s.includes('paradox')) ||
            (s.includes('cannot prove') && s.includes('this')) ||
            (s.includes('set of all sets')));
    }
    isGodelianLimit(question) {
        const q = question.toLowerCase();
        return (q.includes('prove') && q.includes('itself') ||
    ...
    dialecticSynthesize(question, currentAnswer) {
        const thesis = {
            id: 'THESIS_' + Date.now(),
    ...
    truthValueToAnswer(value, question) {
        switch (value) {
...
exports.MetaLogicEngine = MetaLogicEngine;
// Export singleton instance
exports.metaLogic = new MetaLogicEngine();
exports.default = MetaLogicEngine;
