...
exports.getTelemetry = exports.TelemetryService = void 0;
exports.Track = Track;
exports.Timed = Timed;
// ═══════════════════════════════════════════════════════════════════════════════
// TELEMETRY SERVICE
...
class TelemetryService {
    ...
    track(name, category, properties, measurements) {
        if (!this.config.enabled)
            return;
