...
exports.WorkerMemoryGuard = exports.MemoryWatchdog = void 0;
exports.getGlobalWatchdog = getGlobalWatchdog;
exports.startMemoryWatchdog = startMemoryWatchdog;
 ...
 * - 'kill': Worker killed
 */
class MemoryWatchdog extends events_1.EventEmitter {
    config;
    intervalHandle = null;
    memorySamples = [];
...
exports.MemoryWatchdog = MemoryWatchdog;
// ═══════════════════════════════════════════════════════════════════════════════
// SINGLETON INSTANCE
// ═══════════════════════════════════════════════════════════════════════════════
 ...
 */
function startMemoryWatchdog(config) {
...
class WorkerMemoryGuard {
    watchdog;
    workerId;
    constructor(workerId, maxHeapMB = 200) {
...
exports.WorkerMemoryGuard = WorkerMemoryGuard;
// ═══════════════════════════════════════════════════════════════════════════════
// CLI MODE
// ═══════════════════════════════════════════════════════════════════════════════
...
// EXPORTS
// ═══════════════════════════════════════════════════════════════════════════════
exports.default = MemoryWatchdog;
