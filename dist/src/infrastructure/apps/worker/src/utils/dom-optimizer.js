...
exports.optimizeDOM = optimizeDOM;
 ...
 */
function optimizeDOM(html, targetSelector, config = {}) {
    const { maxSizeKB = 15, preserveIds = true, preserveClasses = true, preserveDataAttrs = true, preserveAria = true, preserveTestAttrs = true, focusDepth = 3, interactiveOnly = false, } = config;
 ...
 */
function extractFocusArea(html, selector, depth, maxBytes) {
 ...
 */
function smartTruncate(html, maxBytes) {
