...
exports.getLoadBalancer = exports.LoadBalancer = void 0;
// ═══════════════════════════════════════════════════════════════════════════════
// LOAD BALANCER
// ═══════════════════════════════════════════════════════════════════════════════
class LoadBalancer {
    ...
    getHealthyWorkers() {
        return [...this.workers.values()].filter(w => w.healthy && w.activeConnections < w.maxConnections);
    }
    /**
     ...
     */
    // Complexity: O(1) — lookup
    connectionEnd(workerId, responseTime) {
        const worker = this.workers.get(workerId);
        if (worker) {
    ...
    // Complexity: O(N log N) — sort
    weightedLeastConnections(workers) {
...
// EXPORTS
// ═══════════════════════════════════════════════════════════════════════════════
const getLoadBalancer = () => LoadBalancer.getInstance();
