...
`);
    ...
    async banIP(ip, reason, customDuration) {
        ...
        const durationStr = duration === 'permanent' ? 'permanent' : `${Math.round(durationMs / 3600000)} hours`;
    ...
    getStats() {
        ...
        return {
            ...
            totalViolations: Array.from(this.violationHistory.values()).reduce((sum, v) => sum + v.length, 0),
