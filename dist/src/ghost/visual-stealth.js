...
exports.VisualStealthEngine = void 0;
exports.getVisualStealth = getVisualStealth;
exports.createVisualStealth = createVisualStealth;
...
class VisualStealthEngine {
    ...
    generateCanvasProfile(rng) {
        return {
            ...
            fontRendering: ['default', 'cleartype', 'grayscale'][Math.floor(rng() * 3)]
        };
    }
    // Complexity: O(1)
    generateAudioProfile(rng) {
        return {
...
`;
    ...
    weightedSelect(items, weights, rng) {
        const rand = rng();
        let cumulative = 0;
    ...
    // Complexity: O(1)
    varyValue(value, maxVariation, rng) {
...
exports.VisualStealthEngine = VisualStealthEngine;
// ═══════════════════════════════════════════════════════════════════════════════
// SINGLETON & FACTORY
// ═══════════════════════════════════════════════════════════════════════════════
let defaultEngine = null;
function getVisualStealth(seed) {
    if (!defaultEngine) {
        defaultEngine = new VisualStealthEngine(seed);
    }
    return defaultEngine;
}
function createVisualStealth(seed) {
    return new VisualStealthEngine(seed);
}
exports.default = VisualStealthEngine;
