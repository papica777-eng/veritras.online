...
exports.getEventBus = exports.EventBus = exports.QAntumEvents = void 0;
exports.EmitsEvent = EmitsEvent;
exports.OnEvent = OnEvent;
// ═══════════════════════════════════════════════════════════════════════════════
// PREDEFINED EVENTS
// ═══════════════════════════════════════════════════════════════════════════════
exports.QAntumEvents = {
    // System Events
...
class EventBus {
    ...
    // Complexity: O(N) — linear iteration
    async retryHandler(sub, payload, meta) {
