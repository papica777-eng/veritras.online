...
class PersonaEngine extends events_1.EventEmitter {
    ...
    calculateBehaviorProfile(persona) {
        ...
        const doubleClickProbability = Math.min(0.15, (100 - techSavviness) / 1000 + (persona.ageGroup === 'senior' ? 0.05 : 0));
        return {
            rageClickThreshold,
            rageClickCount,
            minTargetSize,
    ...
    shouldMissClick(targetWidth, targetHeight) {
        ...
        const adjustedProbability = sizeRatio < 1 ? missClickProbability * (2 - sizeRatio) : missClickProbability * sizeRatio;
