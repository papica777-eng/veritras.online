...
exports.COSMIC_TAXONOMY_ASCII = exports.COSMIC_REGISTRY = exports.EvolutionStage = exports.CosmicSense = void 0;
exports.getStatsBySense = getStatsBySense;
// ═══════════════════════════════════════════════════════════════════════════════
// I. СЕДЕМТЕ СЕТИВА - COSMIC SENSES
// ═══════════════════════════════════════════════════════════════════════════════
var CosmicSense;
(function (CosmicSense) {
    /** 👁️ ЗРЕНИЕ - Възприятие на реалността */
    CosmicSense["PERCEPTION"] = "\u0417\u0420\u0415\u041D\u0418\u0415";
    /** 👃 ОБОНЯНИЕ - Откриване на скритото */
    CosmicSense["DETECTION"] = "\u041E\u0411\u041E\u041D\u042F\u041D\u0418\u0415";
    /** 💪 СИЛА - Способност за действие */
    CosmicSense["EXECUTION"] = "\u0421\u0418\u041B\u0410";
    /** ⚡ МОЩ - Интелигентна обработка */
    CosmicSense["PROCESSING"] = "\u041C\u041E\u0429";
    /** 👑 ВЕЛИЧИЕ - Оркестрация на множества */
    CosmicSense["ORCHESTRATION"] = "\u0412\u0415\u041B\u0418\u0427\u0418\u0415";
    /** ♾️ ВЕЧНОСТ - Устойчивост във времето */
    CosmicSense["PERSISTENCE"] = "\u0412\u0415\u0427\u041D\u041E\u0421\u0422";
    /** 🌌 БЕЗКРАЙНОСТ - Трансцендентност */
    CosmicSense["TRANSCENDENCE"] = "\u0411\u0415\u0417\u041A\u0420\u0410\u0419\u041D\u041E\u0421\u0422";
})(CosmicSense || (exports.CosmicSense = CosmicSense = {}));
// ═══════════════════════════════════════════════════════════════════════════════
...
(function (EvolutionStage) {
    ...
    EvolutionStage[EvolutionStage["POTENTIAL"] = 0] = "POTENTIAL";
    /** Първо проявление, базова форма */
    EvolutionStage[EvolutionStage["MANIFESTATION"] = 1] = "MANIFESTATION";
    /** Способност за действие */
    EvolutionStage[EvolutionStage["ACTION"] = 2] = "ACTION";
    /** Разбиране на себе си */
    EvolutionStage[EvolutionStage["UNDERSTANDING"] = 3] = "UNDERSTANDING";
    /** Пълен контрол и майсторство */
    EvolutionStage[EvolutionStage["MASTERY"] = 4] = "MASTERY";
    /** Надхвърляне на ограниченията */
    EvolutionStage[EvolutionStage["TRANSCENDENCE"] = 5] = "TRANSCENDENCE";
    /** Безкрайна еволюция */
    EvolutionStage[EvolutionStage["INFINITY"] = 6] = "INFINITY";
})(EvolutionStage || (exports.EvolutionStage = EvolutionStage = {}));
// ═══════════════════════════════════════════════════════════════════════════════
// IV. РЕГИСТЪР НА МОДУЛИТЕ - 130+ МОДУЛА
// ═══════════════════════════════════════════════════════════════════════════════
exports.COSMIC_REGISTRY = [
    // ═══════════════════════════════════════════════════════════════════════════
...
function getStatsBySense() {
    ...
    for (const module of exports.COSMIC_REGISTRY) {
...
║                                                                               ║
╠═══════════════════════════════════════════════════════════════════════════════╣
║  ОБЩО: ${exports.COSMIC_REGISTRY.length} модула | ~${exports.COSMIC_REGISTRY.reduce((s, m) => s + m.lines, 0).toLocaleString()} LOC | 7 сетива                      ║
╚═══════════════════════════════════════════════════════════════════════════════╝
...
console.log(exports.COSMIC_TAXONOMY_ASCII);
