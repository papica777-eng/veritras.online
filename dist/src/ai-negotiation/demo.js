...
async function runDemo() {
    ...
    const seller = index_1.AgentFactory.createQAntumSalesAgent('ENTERPRISE');
    const buyer = index_1.AgentFactory.createBuyerAgent(250, ['Ghost Protocol', 'Self-Healing', 'API Access']);
    const mediator = index_1.AgentFactory.createMediatorAgent();
