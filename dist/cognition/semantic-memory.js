...
exports.VectorOps = exports.createSemanticMemory = exports.SemanticMemoryBank = void 0;
...
class VectorOps {
     ...
     */
    static textToVector(text, dimension) {
    ...
    consolidate() {
        ...
        for (const entry of this.entries.values()) {
            ...
            for (const result of similar) {
                ...
                entry.metadata.confidence = Math.max(entry.metadata.confidence, result.entry.metadata.confidence);
...
exports.SemanticMemoryBank = SemanticMemoryBank;
// ═══════════════════════════════════════════════════════════════════════════════
// EXPORTS
// ═══════════════════════════════════════════════════════════════════════════════
const createSemanticMemory = (config) => {
    return new SemanticMemoryBank(config);
};
exports.createSemanticMemory = createSemanticMemory;
exports.default = SemanticMemoryBank;
