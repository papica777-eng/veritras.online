...
class CognitionEngine {
    ...
    async reason(problem) {
        ...
        const { finalOutput, iterations, finalScore } = await this.selfCritique.iterateUntilSatisfied(solution, async (sol, weaknesses) => this.improveSolution(sol, weaknesses));
        console.log(`\n✅ COGNITION COMPLETE`);
