...
import { NeuralMesh } from './neural-mesh.ts';
// Cognitive module adapters
import { AutonomousThoughtModule } from './modules/AutonomousThoughtModule.ts';
import { SelfAuditModule } from './modules/SelfAuditModule.ts';
import { SymbolVerifierModule } from './modules/SymbolVerifierModule.ts';
import { MapLookupModule } from './modules/MapLookupModule.ts';
import { SelfHealModule } from './modules/SelfHealModule.ts';
import { PatternAnalysisModule } from './modules/PatternAnalysisModule.ts';
import { GhostReconModule } from './modules/GhostReconModule.ts';
import { SingularityModule } from './modules/SingularityModule.ts';
import { PrecogModule } from './modules/PrecogModule.ts';
import { FortressModule } from './modules/FortressModule.ts';
import { DecryptionEngine } from './decryption-engine.ts';
import { EcosystemRegistry } from './EcosystemRegistry.ts';
